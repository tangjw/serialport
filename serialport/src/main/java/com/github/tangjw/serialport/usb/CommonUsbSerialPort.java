...
package com.github.tangjw.serialport.usb;
...
public abstract class CommonUsbSerialPort implements UsbSerialPort {
    ...
    /**
     * use simple USB request supported by all devices to default if connection is still valid
     */
    ...
    protected int read(final byte[] dest, final int timeout, boolean testConnection) throws IOException {
        ...
        if (timeout != 0) {
            ...
            //   A/libc: Fatal signal 11 (SIGSEGV), code 1 (SEGV_MAPERR), fault addr 0x276a in tid 29846 (pool-2-thread-1), pid 29618 (.usbserial.default)
